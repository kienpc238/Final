<%-- 
    Document   : chitiet_ttn1
    Created on : Jun 2, 2017, 9:19:59 PM
    Author     : Computer
--%>
        ...
        <div id="page">
            ...
            <div class="trongnuoc"><!-- InstanceBeginEditable name="trongnuoc" -->
                ...
                <div style="width:1200px; height:30px; margin:0 auto; position:relative; ">
                    ...
                    <a style="position:absolute; left:62px;" href="CChitiet?tour=TN&ID=<%= id%>"><span style="color:#F00; margin-left:16px; "> <%= tentour%></span></a>
                </div>
                <!-- InstanceEndEditable -->
            ...
            <div id="content">
                ...
                <div id="leftct">
                    <div style="margin-left:20px;" >
                        ...
                        <div style=" float:right; width:340px; height:360px; margin-left:20px; margin-right:0px; margin-top:20px;">
                            ...
                            <div style=" box-sizing: border-box; padding-bottom: 14px;padding-top: 14px;margin-bottom:20px; line-height:28px; color:#666666;width:340px; height:132px; border-top:1px dotted #CCCCCC; border-bottom:1px dotted #CCCCCC; ">
                                <div>Ngày khởi hành: <%= ngaykh%></div>
                                <div>Thời gian: <%= thoigian%></div>
                                <div>Điểm đến: <%= diadiem%></div>
                            </div>
                            <form method="get" action="CGiohang">
                                <div style="font-size:24px; font-weight:600; color:#F00; border-bottom:1px dotted #CCCCCC; padding-bottom:18px;"><%= gia%>VNĐ</div>
                                <div style="padding-top:14px; line-height:20px;"><%= mota%></div>
                                <div id="ct"><a style="color: white; text-decoration: none;" href="CGiohang?tour=TN&value=<%= id%>">Đặt Tour</a></div>
                        ...
                        <div style="width: 860px; height:80px; line-height:30px; text-align:center;"><span style="color:#000; font-weight:600;"><%= mota%></span><br />
                ...
                <div id="right">
                    <div id="boxright">
                        ...
                        <div id="boxrighttt3">
                            <a style=" position:absolute;width:270px; height:203px; display:block; opacity:0.2;" href="baotri.jsp"><img style="position:absolute; top: 71px; right: 105px;" src="Images/icon_Logo/plus-img.png" /></a>
