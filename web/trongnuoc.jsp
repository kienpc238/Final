<%-- 
    Document   : trongnuoc
    Created on : Jun 2, 2017, 9:16:32 PM
    Author     : Computer
--%>
        ...
        <div id="page">
            ...
            <div class="trongnuoc"><!-- InstanceBeginEditable name="trongnuoc" -->
                <div style="width:1200px; height:30px; margin:0 auto; position:relative; ">
                    ...
                    <a style="position:absolute; left:62px;" href="trongnuoc.jsp"><span style="color:#F00; margin-left:16px; ">Tour trong nước</span></a>
                </div>
                <!-- InstanceEndEditable -->
            ...
            <div id="content">
                ...
                <div id="leftnuoc">
                    <div ><h3 id="boxvien1" >du lịch trong nước</h3></div>
                    <%                        String value = "";
                        int trang = 0;
                        int giatri = 0;
                        try {
                    ...
                    %>
                    <div class="boxleftnuoc">
                        <div class="boxleftnuocimg">
                            <a href="CChitiet?tour=TN&ID=<%= ds.getId()%>" style="position:absolute; width:260px; height:198px; display:block;" ><img style=" width:260px; height:198px;background-repeat: no-repeat; background-size: cover;" src="<%= ds.getUrl()%>" /></a>

                            <div class="boxleftnuoctext"><%= ds.getThoigian()%></div>
                        </div>
                        <div class="boxleftnuoc2">
                            <div class="boxleftnuoc3">
                    ...
                    <div class="boxleftnuoc">
                        <div class="boxleftnuocimg">
                            <a href="CChitiet?tour=TN&ID=<%= ds.getId()%>" style="position:absolute; width:260px; height:198px;display:block;" >
                                <img style=" width:260px; height:198px;background-repeat: no-repeat;" src="<%= ds.getUrl()%>" /></a>
                    ...
                    <div class="phantrang" style=" margin-left: 400px;"><a class="phantrangdk" style="text-align: center; line-height: 32px;background-color: #305cb7; width: 32px; height: 32px;margin-bottom: 24px; display: block; float: left; margin-left: 10px; color: white;" href="CPhantrangTN?value=<%= i%>"><%= i%></a></div>
                        <%
                        } else {
                        %>

                    <div class="phantrang" style="margin-left: 400px;"><a style="text-align: center; line-height: 32px;background-color: #305cb7; width: 32px; height: 32px;margin-bottom: 24px; display: block; float: left; margin-left: 10px;" href="CPhantrangTN?value=<%= i%>"><%= i%></a></div>
                        <%}
                            }
                        %>
                </div>    
